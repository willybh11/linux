                                       ...
                                       uint8_t *errorFlag)
{
    ...
    payloadMailbox[4] = (uint8_t)(initCals->chanInitCalMask[ADRV9001_RX1_TX1]) | 0x0C; // errors reported only on | 0x0F, reported on 0x03
    ...
    payloadMailbox[8]  = (uint8_t)(initCals->chanInitCalMask[ADRV9001_RX2_TX2]) | 0x0C; // errors reported only on | 0x0F, reported on 0x03
