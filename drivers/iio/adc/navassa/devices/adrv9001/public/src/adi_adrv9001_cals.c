                                       ...
                                       uint8_t *errorFlag)
{
    ...
    payloadMailbox[5] = (uint8_t)(initCals->chanInitCalMask[ADRV9001_RX1_TX1] >> 8) | 0xF0; // errors with 0x0F masked
    ...
    payloadMailbox[9]  = (uint8_t)(initCals->chanInitCalMask[ADRV9001_RX2_TX2] >> 8) | 0xF0; // errors with 0x0F masked
